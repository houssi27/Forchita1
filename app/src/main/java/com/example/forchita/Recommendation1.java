...
public class Recommendation1 extends Fragment implements Adapter.OnNoteListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.recommandation1, container, false);
        ...
        Call<Post> call= api.getRecommendations(fAuth.getCurrentUser().getUid(), location.getLatitude(), location.getLongitude());
        ...
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, retrofit2.Response<Post> response) {
                Post a= response.body();
                recommendations= a.getOutput();
